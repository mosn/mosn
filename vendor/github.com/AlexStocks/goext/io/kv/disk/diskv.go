...
// Import imports the source file into gxdiskv under the destination key. If the
...
// the disk. Note that EraseAll doesn't distinguish gxdiskv-related data from non-
// gxdiskv-related data. Care should be taken to always specify a gxdiskv base
// directory that is exclusively for gxdiskv data.
