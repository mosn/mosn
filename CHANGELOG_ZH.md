...
- 支持 Listener Filter 的扩展，透明劫持能力基于 Listener Filter 实现 [#1014](https://github.com/mosn/mosn/pull/1014)
- 变量机制新增 Set 方法 [#1024](https://github.com/mosn/mosn/pull/1024)
- 新增 SDS Client 失败时自动重试和异常处理
- 完善 TraceLog，支持注入 context[#1044](https://github.com/mosn/mosn/pull/1044)

### 重构

- 重构 XProtocol Engine，并且重新实现了 SofaRPC 协议 [#1010](https://github.com/mosn/mosn/pull/1010)
  ...
  - 协议解析优化
- 修改 HTTP2 协议的 Encode 方法参数
- 精简了 LDS 接口参数

### 优化

- 优化 Upstream 动态解析域名机制 [#1020](https://github.com/mosn/mosn/pull/1020)
- 优化 TLS 封装，新增了错误日志，修改了兼容模式下的超时时间
- 优化超时时间设置，使用变量机制设置超时时间
- Dubbo 解析库依赖升级到 1.5.0[#1076](https://github.com/mosn/mosn/pull/1076) [@cch123](https://github.com/cch123)
- 引用路径迁移脚本新增 OS 自适应 [#1007](https://github.com/mosn/mosn/pull/1007) [@taomaree](https://github.com/taomaree)

### Bug 修复

- 修复 HTTP2 协议转发时丢失 query string 的问题 [#1077](https://github.com/mosn/mosn/pull/1077) [@champly](https://github.com/champly)
