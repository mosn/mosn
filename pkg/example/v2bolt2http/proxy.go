...
func (ccc *rpclientConnCallbacks) OnEvent(event types.ConnectionEvent) {
	...
	case types.Connected:
		...
		boltV2PostData := buffer.NewIoBufferBytes(boltV2ReqBytes)
