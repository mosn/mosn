...
func TestClusterManagerUpdateCluster(t *testing.T) {
	...
	_, pool := GetClusterMngAdapterInstance().ConnPoolForCluster(mockLbCtx, snapshot, mockProtocol)
...
func TestConnPoolForCluster(t *testing.T) {
	...
	_, connPool := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap, mockProtocol)
	if connPool == nil {
...
func TestConnPoolUpdateTLS(t *testing.T) {
	...
	_, connPool1 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap1, mockProtocol)
	...
	_, connPool2 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap2, mockProtocol)
	...
	_, connPool3 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap2, mockProtocol)
...
func TestClusterManagerTLSUpdateTLS(t *testing.T) {
	...
	DisableClientSideTLS()
	_, connPool2 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap1, mockProtocol)
	...
	//
	EnableClientSideTLS()
	_, connPool3 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap1, mockProtocol)
	...
	snap2 := GetClusterMngAdapterInstance().GetClusterSnapshot(nil, "test1")
	_, connPool4 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap2, mockProtocol)
	...
	_, connPool5 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap2, mockProtocol)
	if !connPool5.TLSHashValue().Equal(connPool4.TLSHashValue()) {
		t.Fatal("conn pool changed, but no config changed")
	}
	// disable tls, connpool should will be changed
	DisableClientSideTLS()
	_, connPool6 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap2, mockProtocol)
	...
	_, connPool7 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap3, mockProtocol)
	...
	EnableClientSideTLS()
	_, connPool8 := GetClusterMngAdapterInstance().ConnPoolForCluster(newMockLbContext(nil), snap3, mockProtocol)
