...
func (p *mockConnPool) NewStream(ctx context.Context, receiver types.StreamReceiveListener, _ api.Connection) (types.PoolFailureReason, types.Host, types.StreamSender) {
	return "", nil, nil
}
