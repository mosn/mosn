...
const (
	...
	VarConnReadBufferCapacity      = "conn_read_buffer_capacity"
...
var (
	...
	VariableConnReadBufferCapacity      = variable.NewVariable(VarConnReadBufferCapacity, nil, nil, variable.DefaultSetter, 0)
...
func init() {
	builtinVariables := []variable.Variable{
		...
		VariableListenerPort, VariableListenerName, VariableListenerType, VariableConnReadBufferCapacity, VariableNetworkFilterChainFactories,
