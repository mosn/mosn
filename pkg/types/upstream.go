...
type HostStats struct {
	...
	UpstreamResponse1xx                            metrics.Counter
	UpstreamResponse2xx                            metrics.Counter
	UpstreamResponse3xx                            metrics.Counter
	UpstreamResponse4xx                            metrics.Counter
	UpstreamResponse5xx                            metrics.Counter
}
