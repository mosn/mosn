...
func NewRpcRequest(requestId uint32, headers types.HeaderMap, data api.IoBuffer) *Request {
	request := &Request{
...
func NewRpcResponse(requestId uint32, statusCode uint16, headers types.HeaderMap, data api.IoBuffer) *Response {
	response := &Response{
