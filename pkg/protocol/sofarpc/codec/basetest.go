...
//	"gitlab.alipay-inc.com/afe/mosn/pkg/protocol/basic"
//)
//
//func protocal_test() {
//	//initilize codec engine. TODO: config driven
//	codecImpl := basic.NewProtocols(map[byte]basic.Protocol{
//		basic.PROTOCOL_CODE_V1: BoltV1,
//		basic.PROTOCOL_CODE_V2: BoltV2,
//		//protocol.PROTOCOL_CODE:basic.Tr,
//	})
//
//	fakePipe := make(chan basic.RpcCommand)
//
//	//plug-in tr codec
//	codecImpl.PutProtocol(basic.PROTOCOL_CODE, Tr)
//
