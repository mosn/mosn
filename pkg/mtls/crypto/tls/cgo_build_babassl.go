...
// #cgo linux,!arm,!arm64 LDFLAGS: -L${SRCDIR}/linux_BabaSSL_lib/lib ${SRCDIR}/linux_BabaSSL_lib/lib/libssl.a ${SRCDIR}/linux_BabaSSL_lib/lib/libcrypto.a -ldl -lpthread
// #cgo linux,arm64 CFLAGS: -I${SRCDIR}/linux_openssl_arm_lib/include -Wno-deprecated-declarations
// #cgo linux,arm64 LDFLAGS: -L${SRCDIR}/linux_BabaSSL_arm_lib/lib ${SRCDIR}/linux_BabaSSL_arm_lib/lib/libssl.a ${SRCDIR}/linux_BabaSSL_arm_lib/lib/libcrypto.a -ldl -lpthread
import "C"
