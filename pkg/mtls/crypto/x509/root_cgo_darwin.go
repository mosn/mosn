...
// FetchPEMRootsBabaSSL fetches the system's list of trusted X.509 root certificates
...
int FetchPEMRootsBabaSSL(CFDataRef *pemRoots, CFDataRef *untrustedPemRoots, bool debugDarwinRoots) {
	int i;
...
func loadSystemRoots() (*CertPool, error) {
	...
	err := C.FetchPEMRootsBabaSSL(&data, &untrustedData, C.bool(debugDarwinRoots))
	if err == -1 {
