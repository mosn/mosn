...
var (
	...
	builtinVariables = []variable.Variable{
		...
		variable.NewVariable(types.VarResponseUseStream, nil, nil, variable.DefaultSetter, 0),
		variable.NewVariable(types.VarResponseEndStream, nil, nil, variable.DefaultSetter, 0),
	}
