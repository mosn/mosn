...
func (p *connpoolPingPong) NewStream(ctx context.Context, receiver types.StreamReceiveListener, _ api.Connection) (types.PoolFailureReason, types.Host, types.StreamSender) {
	host := p.Host()
