...
func (conn *streamConnection) Dispatch(buffer types.IoBuffer) {
	...
	for _, request := range requestList {
		...
		conn.OnReceive(conn.context, streamID, protocol.CommonHeader(headers), reqBuf, span, isHearbeat)
...
func (conn *streamConnection) OnReceive(context context.Context, streamID string, headers types.HeaderMap, data types.IoBuffer, span types.Span, isHearbeat bool) types.FilterStatus {
