...
func TestBoltTLS(t *testing.T) {
	Scenario(t, "simple boltv1 proxy use tls between mosns", func() {
		_, _ = lib.InitMosn(ConfigTLSBolt, lib.CreateConfig(MockBoltServerConfig))
		Case("bolt protocol with tls", func() {
