...
func TestHTTPTLS(t *testing.T) {
	Scenario(t, "simple http proxy use tls between mosns", func() {
		_, _ = lib.InitMosn(ConfigTLSHttp, lib.CreateConfig(MockHTTPServerConfig))
		Case("http protocol with tls", func() {
