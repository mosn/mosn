...
func NewHelloExampleGrpcServer(_ context.Context, _ json.RawMessage) (mgrpc.RegisteredServer, error) {
	s := grpc.NewServer()
...
func NewEchoStreamGrpcServer(_ context.Context, _ json.RawMessage) (mgrpc.RegisteredServer, error) {
