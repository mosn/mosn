...
func handleEndpointsRespDeprecated(msg *xdsapi.DiscoveryResponse) []*xdsapi.ClusterLoadAssignment {
...
func handleClustersRespDeprecated(msg *xdsapi.DiscoveryResponse) []*xdsapi.Cluster {
...
func handleXdsDataDeprecated(mosnConfig *v2.MOSNConfig, xdsFiles []string) error {
...
func TestConfigAddAndUpdateDeprecated(t *testing.T) {
