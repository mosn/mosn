...
## 新增最大 Header 大小限制的配置选项。优化 http 场景下的 buffer 申请
...
```log
2020-09-30 09:25:46,54 [DEBUG] new idlechecker: maxIdleCount:6, conn:2
2020-09-30 09:25:46,54 [TRACE] [proxy] extend config = map[max_header_size:100]
2020-09-30 09:25:46,54 [TRACE] [proxy] extend config proxyGeneralExtendConfig = {false 0 100}
2020-09-30 09:25:46,54 [DEBUG] [server] [listener] accept connection from 127.0.0.1:2046, condId= 2, remote addr:127.0.0.1:65470
```
